...
<!--			</div>-->
            ...
            <div class="layui-form-item">
                <label for="L_pass" class="layui-form-label" style="width: 30%;">
                    <span class="x-red">*</span>新房交易管理
                </label>
                <div class="layui-input-inline" style="width: 610px;">
                    <textarea id="xintext" name="xintext" placeholder="请输入内容" lay-verify="xintext" class="layui-textarea"><?php echo $xintext ?></textarea>
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form','layedit', 'layer'],
        function () {
            ...
            var editIndex1 = layedit.build('xintext', {
                height: 300,
            });
