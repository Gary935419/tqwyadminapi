                    ...
                    <table class="layui-table layui-form">
                        ...
                        <?php if (isset($list) && !empty($list)) { ?>
                            <?php foreach ($list as $num => $once): ?>
                                <tr id="p<?= $once['uid'] ?>" sid="<?= $once['uid'] ?>">
                                    <td><?= $num + 1 ?></td>
                                    <td><?= $once['user_name'] ?></td>
                                    <td><?= $once['rname'] ?></td>
                                    ...
                                    <td class="td-manage">
                                        <button class="layui-btn layui-btn-normal"
                                                onclick="xadmin.open('编辑','<?= RUN . '/users/users_edit?uid=' ?>'+<?= $once['uid'] ?>,900,500)">
                                            <i class="layui-icon">&#xe642;</i>编辑
                                        </button>
                                        <button class="layui-btn layui-btn-danger"
                                                onclick="users_delete('<?= $once['uid'] ?>')"><i class="layui-icon">&#xe640;</i>删除
                                        </button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
