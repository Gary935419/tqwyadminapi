        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" method="get" action="<?= RUN, '/goods/items_list' ?>">
                ...
                <button class="layui-btn layui-card-header" style="float: right;margin-top: -40px;margin-right: 20px;"
                        onclick="xadmin.open('添加','<?= RUN . '/goods/items_add' ?>',1000,600)"><i
                                ...
                                <tr id="p<?= $once['id'] ?>" sid="<?= $once['id'] ?>">
                                    ...
                                    <td class="td-manage">
                                        <button class="layui-btn layui-btn-normal"
                                                onclick="xadmin.open('编辑','<?= RUN . '/goods/items_edit?id=' ?>'+'<?= $once['id'] ?>',1000,600)">
