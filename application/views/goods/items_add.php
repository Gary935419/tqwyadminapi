        ...
        <form method="post" class="layui-form" action="" name="basic_validate" id="tab">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="ename" name="ename" lay-verify="ename"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="etitle" name="etitle" lay-verify="etitle"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
            <div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="unitprice" name="unitprice" lay-verify="unitprice"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="unitnums" name="unitnums" lay-verify="unitnums"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="batchprice" name="batchprice" lay-verify="batchprice"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="batchnums" name="batchnums" lay-verify="batchnums"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="topprice" name="topprice" lay-verify="topprice"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="topnums" name="topnums" lay-verify="topnums"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="sumnums" name="sumnums" lay-verify="sumnums"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="place" name="place" lay-verify="place"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="delivery" name="delivery" lay-verify="delivery"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 300px;">
                    <input type="number" id="esort" name="esort" lay-verify="esort"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 500px;">
                    <input type="radio" name="ishot" lay-skin="primary" title="推荐首页" value="1" checked>
                    <input type="radio" name="ishot" lay-skin="primary" title="暂不推荐" value="0">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="L_pass" class="layui-form-label" style="width: 30%;">
                    <span class="x-red">*</span>商品列表图
                </label>
                <div class="layui-input-inline" style="width: 300px;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline" style="width: 610px;">
                    <textarea id="content" name="content" placeholder="请输入内容" lay-verify="content" class="layui-textarea"></textarea>
                </div>
            </div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label" style="width: 30%;">
				...
				<div class="layui-input-inline" style="width: 610px;">
					<textarea id="parameter" name="parameter" placeholder="请输入内容" lay-verify="parameter" class="layui-textarea"></textarea>
				</div>
			</div>
            <div class="layui-form-item">
